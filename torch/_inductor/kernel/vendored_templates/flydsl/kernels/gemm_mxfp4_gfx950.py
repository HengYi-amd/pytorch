    ...
    *,
    ...
    def kernel(
        ...
        def read_frag(base_i32, row, kh):
            ...
            off = row * fx.Int32(row_dwords) + granule * fx.Int32(
                GFX950_DMA_BYTES // 4
            )
            ...
            if const_expr(packed_scale):
                ...
                for kh in range_constexpr(d.k_halves):
                    ...
                    issued.append(
                        (
                            packed_scale_issue(
                                sa32, m_base, a_row_base, m_repeat_stride, d.mma_m_repeat, col32
                            ),
                            packed_scale_issue(
                                sb32, n_base, b_row_base, n_repeat_stride, d.mma_n_repeat, col32
                            ),
                        )
                    )
                av, bv = mid()
