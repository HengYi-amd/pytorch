...
def use_flydsl_mxfp4_template(layout: Layout) -> bool:
    """Return whether the gfx950 MXFP4 FlyDSL template may be selected."""
    ...
    try:
        ...
        log.debug("Could not determine ROCm arch for MXFP4 FlyDSL gate", exc_info=True)
        return False
